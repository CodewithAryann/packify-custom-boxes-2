...
const products = [
  {
    ...
    description: 'Custom mailer boxes offer secure, stylish packaging for e-commerce and subscription products. Our printed mailer boxes are designed for durability and brand impact, enhancing presentation while protecting contents during shipping.',
  ...
  },
  {
    ...
    description: 'Compact and sturdy custom tuck boxes are ideal for packaging lightweight items like cosmetics, jewelry, or gifts. Their easy-to-close tuck flap ensures secure storage with a neat, professional look for retail packaging.',
  ...
  },
  {
    ...
    description: 'Premium custom rigid boxes deliver sturdy packaging solutions ideal for luxury products. With high-end finish and solid chipboard structure, our rigid gift boxes deliver an exceptional unboxing experience and strong brand presence.',
  ...
  },
  {
    ...
    description: 'Custom dispenser boxes are specially designed cardboard packages that provide convenient, controlled access to their contents through easy-to-tear perforated openings, perfect for retail display and point-of-sale packaging.',
  ...
  },
  {
    ...
    description: 'Stylish and protective custom cigarette boxes are designed to preserve freshness and enhance brand appeal with customizable finishes, sizes, and secure closures for tobacco packaging.',
  ...
  },
  {
    ...
    description: 'Custom burger boxes keep your food fresh, secure, and visually appealing. Perfect for dine-in, takeout, or delivery, these food boxes offer durability, insulation, and custom branding options for restaurants.',
  ...
  },
  {
    ...
    description: 'Magnetic closure boxes deliver premium unboxing experience with sleek design and secure magnetic flap. Ideal for luxury gifts and high-end products, these magnetic gift boxes combine elegance with functionality.',
  ...
  },
  {
    ...
    description: 'Custom cosmetic boxes enhance your brand\'s image while securely packaging skincare and beauty products. Sleek, durable, and fully customizable, these beauty boxes are perfect for both retail display and gifting.',
    ...
    <section className="type py-16 bg-white" id="type">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <h2 className="text-4xl font-extrabold text-orange-500 mb-4">
          <span className="text-black">Custom Printed</span> Boxes Wholesale USA
        </h2>
        <p className="text-black text-lg mb-12">
          Explore custom packaging boxes that are stylish and functional, perfectly crafted to showcase, store, and protect your products. Premium wholesale packaging solutions with free design support.
        </p>
